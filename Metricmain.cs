...
public class Metricconvertermain
{
    static void Main(string[] args)
    {System.Console.WriteLine("Welcome to the main method of imperial to metric program.");
     Metricinterface metricapp = new Metricinterface();
     Application.Run(metricapp);
